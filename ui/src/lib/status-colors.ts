...
export const issueStatusIcon: Record<string, string> = {
  ...
  blocked_pending_human: "text-amber-600 border-amber-600 dark:text-amber-400 dark:border-amber-400",
...
export const issueStatusText: Record<string, string> = {
  ...
  blocked_pending_human: "text-amber-600 dark:text-amber-400",
...
export const statusBadge: Record<string, string> = {
  ...
  blocked_pending_human: "bg-amber-100 text-amber-700 dark:bg-amber-900/50 dark:text-amber-300",
