...
export const issueStatusOrder = ["in_progress", "todo", "backlog", "in_review", "blocked_pending_human", "blocked", "done", "cancelled"];
export const issuePriorityOrder = ["critical", "high", "medium", "low"];

export const issueQuickFilterPresets = [
  { label: "All", statuses: [] as string[] },
  { label: "Active", statuses: ["todo", "in_progress", "in_review", "blocked_pending_human", "blocked"] },
