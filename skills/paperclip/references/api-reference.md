...
**Comments endpoint:** returns latest 30 by default, bodies capped at 2 000 chars. Pass `?full=true` to disable both limits.
...
| Get comments (default: 30, truncated)     | `GET /api/issues/:issueId/comments`                                                        |
| Get full thread (no cap)                  | `GET /api/issues/:issueId/comments?full=true`                                              |
